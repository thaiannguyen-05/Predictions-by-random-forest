...
const DUMMY_NEWS: NewsItem[] = [
  {
    ...
    summary:
      "Quyết định bất ngờ của nhóm sản xuất dầu mỏ lớn đã đẩy giá dầu thô tăng 3%, tác động đến cổ phiếu ngành năng lượng.",
    source: "Bloomberg",
    timeAgo: "1 giờ trước",
  },
  {
    ...
    summary:
      "Dòng tiền đổ mạnh vào nhóm cổ phiếu ngân hàng và bất động sản, báo hiệu một xu hướng tăng trưởng tích cực trong ngắn hạn.",
    source: "CafeF",
    timeAgo: "3 giờ trước",
  },
  {
    id: 3,
    title:
      "Fed báo hiệu giữ lãi suất cao lâu hơn dự kiến, thị trường toàn cầu phản ứng trái chiều",
    summary:
      "Biên bản cuộc họp FOMC cho thấy các thành viên lo ngại về lạm phát dai dẳng, gây áp lực lên các thị trường mới nổi.",
    source: "Reuters",
